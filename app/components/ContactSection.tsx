...
export default function ContactSection() {
  ...
  return (
    <section className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-dark-blue text-white shadow-b-sm shadow-gold-dark">
      ...
      >
        <h2 className="text-3xl lg:text-4xl font-semibold mb-8">Get Your Free <span className="text-gold-dark">Consultation</span></h2>
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex justify-center lg:justify-start">
            <button
              type="submit"
              className="bg-gold-dark text-white font-semibold py-3 px-8 rounded-full hover:bg-gold-light transition"
            >
              Send Message
            </button>
          </div>
      ...
      >
        <div className="space-y-3">
          <h3 className="text-2xl font-bold">Contact <span className="text-gold-dark">Information</span></h3>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h4 className="text-lg font-semibold text-gold-dark">Office Location</h4>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h4 className="text-lg font-semibold text-gold-dark">Phone</h4>
              <p>+1 (323) 555-2525</p>
            </div>
          </div>
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h4 className="text-lg font-semibold text-gold-dark">Email</h4>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h4 className="text-lg font-semibold text-gold-dark">Business Hours</h4>
